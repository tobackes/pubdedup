...
_selection     = [4,5,6,7,8,9,10,11]; #TODO: Load this from a mapping file!
_columns       = ['repID','freq']+['l','l_','f1','f1_','f2','f2_','f3','f3_'];
_types         = ['TEXT PRIMARY KEY ON CONFLICT IGNORE','INT','TEXT','TEXT','TEXT','TEXT','TEXT','TEXT','TEXT','TEXT'];
_questionmarks = ','.join(['?' for i in range(len(_columns))]);
_ftypes        = ','.join(_columns);
